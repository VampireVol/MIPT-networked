...
int main(int, char**)
{
    ...
    bool show_rooms_list_window = true;
    bool show_create_room_window = true;
    bool show_room_window = true;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (show_create_room_window)
        {
          ...
          ImGui::InputText("Room name", &data.name);
          ImGui::SliderInt("Max players", &data.maxPlayers, 1, 16);
          static int item_current = 0;
          ImGui::Combo("Type", &data.type, "Agar\0Cars\0\0");
          ImGui::Button("Create", { buttonSize , 0 } );
